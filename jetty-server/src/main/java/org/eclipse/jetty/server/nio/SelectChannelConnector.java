...
public class SelectChannelConnector extends AbstractNIOConnector
{
    ...
    public void accept(int acceptorID) throws IOException
    {
        ...
        {
            final SocketChannel channel = _acceptChannel.accept();
	...
	private void readLoop(SocketChannel socketChannel) throws IOException {
...
//		String s = new String(Arrays.copyOfRange(buffer.array(),0,buffer.position()));
//		LOG.info("s="+s);
//		System.out.println(s);
//		if (s.equals("<policy-file-request/>")) {
//			try {
//				socketChannel.write(ByteBuffer.wrap(xml.getBytes()));
//			} catch (IOException e) {
//				// TODO Auto-generated catch block
...
//		}
        ...
        configure(socket);
        _manager.register(socketChannel);
	}
